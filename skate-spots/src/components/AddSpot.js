...
export default function AddSpot() {
  ...
  const handleFileChange = (e) => {
    console.log(
      "inside handleFileChange(), e.target.files is ",
      e.target.files
    );
    ...
    <div className="AddSpot">
      ...
      <div className="map-form-container">
        ...
        <div className="form-container half-map-form-container">
          <p className="add-instructions">
            <HiCursorClick />{" "}
            <strong>
              Click on the map to fill latitude and longitude fields.
            </strong>
          </p>
          <form onSubmit={handleSubmit} className="add-form">
            ...
            <label htmlFor="skate-stopped">
              Skate-stopped?
              <input
                type="radio"
                value="yes"
                name="skate-stopped"
                checked={skateStopped === "yes"}
            ...
            <label htmlFor="tag">
              ...
              />
              <p className="tag-directions">
                (Type a tag and press SPACE to add it to the list. Use hyphens
                instead of spaces in tags, e.g. ride-on-grind)
              </p>
            </label>
            ...
            <p className="youtube-directions">
              NOTE: URL format must be https://www.youtube.com/
              <strong>embed</strong>/ZZ5vETmUYQA<strong>?start</strong>=139, NOT
              https://youtu.be/ZZ5vETmUYQA?<strong>t=139</strong>
            </p>
            <p className="youtube-directions">
              You can build this link yourself by ensuring that{" "}
              <strong>/embed</strong> and <strong>?start</strong> are included,
              or click the "Embed" option after clicking "Share" on YouTube (and
              take only the link from the embed code).
            </p>
